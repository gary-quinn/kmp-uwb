...
class FakeRangingSessionTest {
    ...
    @Test
    fun startTransitionsToActiveRanging() = runTest {
        val session = FakeRangingSession()
    ...
    @Test
    fun startAddsPeerToActivePeers() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
    ...
    @Test
    fun closeTransitionsToStoppedByRequest() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
        session.close()
    ...
    @Test
    fun closeClearsActivePeers() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
        session.close()
    ...
    @Test
    fun simulatePeerLostRemovesPeer() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
    ...
    @Test
    fun simulateErrorTransitionsToStoppedByError() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
    ...
    @Test
    fun simulateSuspendTransitionsToSuspended() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
    ...
    @Test
    fun simulateResumeTransitionsToRanging() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
        session.simulateSuspend()
    ...
    @Test
    fun simulatePeerDisconnectTransitionsToStoppedByPeer() = runTest {
        val session = FakeRangingSession()
        session.start(testPeer)
